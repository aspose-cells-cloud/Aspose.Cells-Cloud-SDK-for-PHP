<?php
/**
 * ConvertWorkbook — Workbook-Level Conversion
 *
 * Demonstrates comprehensive workbook conversion operations:
 * - Convert local workbook to PDF directly
 * - Upload workbook to cloud, then export to various formats
 * - Save-as operations with cloud storage
 */
...
// Export a cloud Excel file to another format, save to local file.
...
// Export a worksheet of cloud Excel file to another format, save to local file.
...
// Export a list object of cloud Excel file to another format, save to local file.
...
// Save-as: convert and store in cloud, then download.
...
// ---- Local File: Chart, Range, Table Conversions ----
